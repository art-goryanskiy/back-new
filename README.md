...
> Плейсхолдеры: добавь сюда ссылки на демо и/или скриншоты (в репозитории или в облаке).
...
- `docs/screenshots/programs-list.png` — список программ, фильтрация/пагинация
- `docs/screenshots/program-details.png` — карточка программы
- `docs/screenshots/admin-users.png` — админка пользователей
- `docs/screenshots/auth-flow.png` — регистрация/подтверждение/сброс пароля
...
src/
  ...
  programs/                     # программы (schema/service/resolver + cache/query/validation)
...
Добавь сюда ссылки на GitHub/LinkedIn/Telegram и короткое описание твоей роли/задач в проекте.
